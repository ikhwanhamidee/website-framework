                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('user/gallery-add'); ?>" method="post" enctype="multipart/form-data">
                                <div class="">
                                            ...
                                            <?php foreach ($gallerys as $gallery) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('user/gallery-delete/' . $gallery['id']); ?>" class="btn red" onclick="return confirm('Are you sure you want to delete <?php echo $gallery['pic_name']; ?>?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
