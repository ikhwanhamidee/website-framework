                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('user/news-add'); ?>" method="post" enctype="multipart/form-data">
                                <div class="">
                                            ...
                                            <?php foreach ($news as $new) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('user/news-edit/' . $new['id']); ?>" class="btn green">Edit</a>
                                                            <a href="<?php echo base_url('user/news-delete/' . $new['id']); ?>" class="btn red" onclick="return confirm('Are you sure you want to delete <?php echo $new['news_title']; ?>?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
