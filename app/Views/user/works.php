                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('user/works-add'); ?>" method="post">
                                <div class="">
                                            ...
                                            <?php foreach ($works as $work) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('user/works-edit/' . $work['id']); ?>" class="btn green">Edit</a>
                                                            <a href="<?php echo base_url('user/works-delete/' . $work['id']); ?>" class="btn red" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
