                            ...
                            <div class="col-lg-8 col-xl-8">
                                ...
                                <div class="recent-news blog-lg">
                                    <div class="action-box blog-lg">
                                        <img src="/assets/images/news/<?php echo $selectednews['news_pic']; ?>">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                                            <li><a><i class="fa fa-calendar"></i><?php echo $selectednews['news_date']; ?></a></li>
                                            <li><a><i class="fa fa-user"></i><?php echo $selectednews['news_author']; ?></a></li>
                                        </ul>
                                        <h5 class="post-title"><a><?php echo $selectednews['news_title']; ?></a></h5>
                                        <p><?php echo $selectednews['news_content']; ?></p>
