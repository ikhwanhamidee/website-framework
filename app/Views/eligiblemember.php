		...
		<div class="page-content bg-white">
			...
			<div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner1.jpg);">
				<div class="container">
					<div class="page-banner-entry">
						<h1 class="text-white">Who is eligible to become a member?</h1>
					</div>
				</div>
			</div>
			<!-- Breadcrumb row -->
			<div class="breadcrumb-row">
				<div class="container">
					<ul class="list-inline">
						...
						<li>Who is eligible to become a member?</li>
					</ul>
				</div>
			</div>
			<!-- Breadcrumb row END -->
			...
			<div class="section-area section-sp1">
				<div class="container">
					...
					<h3 class="post-title"><br>Who is eligible to become a member? </h3>
					<p>1.Composer<br>
						2.Lyricist <br>
						3.Music Arranger<br>
						4.Musician<br>
						5.Singer<br>
						6.Recording Studio/Company<br>
						7.Publisher</p>
