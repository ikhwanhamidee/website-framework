    ...
    <main class="ttr-wrapper">
        <div class="container-fluid">
            <div class="db-breadcrumb">
                <h4 class="breadcrumb-title">List of Work</h4>
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/works-add'); ?>" method="post">
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="song_name" name="song_name" type="text" placeholder="Song Title">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('song_name') ?></small>
                                        <?php endif; ?>
                                    </div>
                                    <div for="member_name" class="form-group row">
                                        <label class="col-sm-2 col-form-label">Member Name</label>
                                        <div class="col-sm-7">
                                            <select name="member_name" id="member_name" type="text" class="form-control" aria-describedby="icHelpBlock">
                                                <?php foreach ($members as $member) : ?>
                                                    <option class="text-black" value="<?php echo $member['member_name']; ?>"><?php echo $member['member_name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <?php if (isset($validation)) : ?>
                                                <small class="text-danger"><?= $validation->getError('member_name') ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <div class="widget-inner">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped align-items-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="min-width: 200px;">Song Title</th>
                                            <th class="text-center" style="min-width: 150px;">Member Name</th>
                                        ...
                                        <?php if ($works) : ?>
                                            ...
                                            <?php foreach ($works as $work) : ?>
                                                <tr>
                                                    ...
                                                    <td ><?php echo $work['song_name']; ?></td>
                                                    <td ><?php echo $work['member_name']; ?></td>
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('admin/works-edit/' . $work['id']); ?>" class="btn green">Edit</a>
                                                            <a href="<?php echo base_url('admin/works-delete/' . $work['id']); ?>" class="btn red" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                ...
                                <div class="pagination">
                                    <?= $pager->links('works', 'pagination_bootstrap1'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
