                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/works-update'); ?>" method="post" enctype="multipart/form-data">
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="song_name" name="song_name" type="text" placeholder="Member ID" value="<?php echo $work['song_name']; ?>">
                                        </div>
                                    ...
                                    <div for="member_name" class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" type="text" id="member_name" name="member_name" placeholder="Member Name" value="<?php echo $work['member_name']; ?>">
                                            <?php if (isset($validation)) : ?>
