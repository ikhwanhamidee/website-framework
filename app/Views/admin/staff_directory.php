                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/staff-add'); ?>" method="post" enctype="multipart/form-data">
                                <div class="">
                                            ...
                                            <?php foreach ($staffs as $staff) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('admin/staff-edit/' . $staff['id']); ?>" class="btn green">Edit</a>
                                                            <a href="<?php echo base_url('admin/staff-delete/' . $staff['id']); ?>" class="btn red" onclick="return confirm('Are you sure you want to delete <?php echo $staff['staff_name']; ?>?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
