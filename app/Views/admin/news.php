    ...
    <main class="ttr-wrapper">
        <div class="container-fluid">
            <div class="db-breadcrumb">
                <h4 class="breadcrumb-title">MRS News</h4>
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/news-add'); ?>" method="post" enctype="multipart/form-data">
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_title" name="news_title" type="text" placeholder="News Title">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('news_title') ?></small>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">News Content</label>
                                        <div class="col-sm-7">
                                            <textarea class="form-control" type="text" id="news_content" name="news_content"></textarea>
                                            <?php if (isset($validation)) : ?>
                                                <small class="text-danger"><?= $validation->getError('news_content') ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">News Author</label>
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_author" name="news_author" type="text" placeholder="News Author">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('news_author') ?></small>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">News Date</label>
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_date" name="news_date" type="date" placeholder="News Date">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('news_date') ?></small>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">News Picture</label>
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_pic" name="news_pic" type="file" placeholder="news_pic">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('news_pic') ?></small>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped align-items-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="min-width: 150px;">News Title</th>
                                            <th class="text-center" style="min-width: 150px;">News Content</th>
                                            <th class="text-center" style="min-width: 150px;">News Author</th>
                                            <th class="text-center" style="min-width: 150px;">News Date</th>
                                            <th class="text-center" style="min-width: 150px;">News Picture</th>
                                        ...
                                        <?php if ($news) : ?>
                                            ...
                                            <?php foreach ($news as $new) : ?>
                                                <tr>
                                                    ...
                                                    <td ><?php echo $new['news_content']; ?></td>
                                                    <td ><?php echo $new['news_author']; ?></td>
                                                    <td ><?php echo date('d-m-y', strtotime($new['news_date'])); ?></td>
                                                    <td ><div class="d-flex justify-content-center">
                                                                        <img id="myImg" src="/assets/images/news/<?php echo $new['news_pic']; ?>" style="max-width: 150px;">
                                                                    </div></td>
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('admin/news-edit/' . $new['id']); ?>" class="btn green">Edit</a>
                                                            <a href="<?php echo base_url('admin/news-delete/' . $new['id']); ?>" class="btn red" onclick="return confirm('Are you sure you want to delete <?php echo $new['news_title']; ?>?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
