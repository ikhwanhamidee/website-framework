                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/news-update'); ?>" method="post" enctype="multipart/form-data">
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_title" name="news_title" type="text" placeholder="News Title" value="<?php echo $news['news_title']; ?>">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('news_title') ?></small>
                                        <?php endif; ?>
                                    </div>
                                    <div for="news_content" class="form-group row">
                                        <label class="col-sm-2 col-form-label">News Content</label>
                                        <div class="col-sm-7">
                                            <textarea class="form-control" type="text" id="news_content" name="news_content" placeholder="News Content"><?php echo $news['news_content']; ?></textarea>
                                            <?php if (isset($validation)) : ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_author" name="news_author" type="text" placeholder="News Author" value="<?php echo $news['news_author']; ?>">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">News Title</label>
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_date" name="news_date" type="date" placeholder="News Date" value="<?php echo $news['news_date']; ?>">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="news_pic" name="news_pic" type="file" placeholder="News Picture">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                        <img id="myImg" src="/assets/images/news/<?php echo $news['news_pic']; ?>" onclick="onClick(this)" style="max-width: 150px;">
                                        </div>
                                    </div>
