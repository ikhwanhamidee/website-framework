    ...
    <main class="ttr-wrapper">
        <div class="container-fluid">
            <div class="db-breadcrumb">
                <h4 class="breadcrumb-title">MRS Membership</h4>
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/members-add'); ?>" method="post">
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="member_id" name="member_id" type="text" placeholder="Member ID">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('member_id') ?></small>
                                        <?php endif; ?>
                                    </div>
                                    <div for="member_name" class="form-group row">
                                        <label class="col-sm-2 col-form-label">Member Name</label>
                                        <div class="col-sm-7">
                                            <input class="form-control" type="text" id="member_name" name="member_name" placeholder="Member Name">
                                            <?php if (isset($validation)) : ?>
                                ...
                                <table id="example1" class="table table-bordered table-striped align-items-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="min-width: 200px;">Member ID</th>
                                            ...
                                            <?php foreach ($members as $member) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('admin/members-edit/'.$member['id']);?>" class="btn green">Edit</a>
                                                            <a href="<?php echo base_url('admin/members-delete/'.$member['id']);?>" class="btn red"  onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
