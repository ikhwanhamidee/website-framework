    ...
    <main class="ttr-wrapper">
        <div class="container-fluid">
            <div class="db-breadcrumb">
                <h4 class="breadcrumb-title">MRS Gallery</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        <div class="wc-title">
                            <h4>Add MRS Picture</h4>
                        </div>
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/gallery-add'); ?>" method="post" enctype="multipart/form-data">
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" id="pic_name" name="pic_name" type="file" placeholder="pic_name">
                                        </div>
                                        <?php if (isset($validation)) : ?>
                                            <small class="text-danger"><?= $validation->getError('pic_name') ?></small>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="">
                                    <div class="">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <button type="submit" class="btn">Add Picture</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped align-items-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="min-width: 300px;">Picture</th>
                                            ...
                                            <?php foreach ($gallerys as $gallery) : ?>
                                                <tr>
                                                    ...
                                                    <td ><div class="d-flex justify-content-center">
                                                                        <img id="myImg" src="/assets/images/gallery/<?php echo $gallery['pic_name']; ?>" style="max-width: 300px;">
                                                                    </div></td>
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="<?php echo base_url('admin/gallery-delete/' . $gallery['id']); ?>" class="btn red" onclick="return confirm('Are you sure you want to delete <?php echo $gallery['pic_name']; ?>?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
