                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            <form class="edit-profile m-b30" action="<?php echo base_url('admin/update-profile'); ?>" method="post">
                                <div class="">
                            ...
                            <form class="edit-profile" action="<?php echo base_url('admin/change-password'); ?>" method="post">
                                <div class="">
                                    <!-- flashdata for success -->
